...
if ('/home/jesusda91/wordpress-4.9.8-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/jesusda91/wordpress-4.9.8-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
